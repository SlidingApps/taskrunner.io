...
@Component({
    selector: 'account-get-started-password-confirmation',
    template: `
    <!-- ACCOUNT.GET-STARTED.PASSWORD-CONFIRMATION: BEGIN -->
    <div class="row">
    ...
    <!-- ACCOUNT.GET-STARTED.PASSWORD-CONFIRMATION: END -->
    `
})
@Inject(EventHub)
export class PasswordConfirmation {
    ...
    private ngOnDestroy(): void {
        if (this.validator && !this.validator.isUnsubscribed) { this.validator.unsubscribe(); }
    }
